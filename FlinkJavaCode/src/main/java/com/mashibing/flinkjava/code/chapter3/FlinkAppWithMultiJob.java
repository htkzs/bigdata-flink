package com.mashibing.flinkjava.code.chapter3;
...
public class FlinkAppWithMultiJob {
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<String> ds1 = env.socketTextStream("node05", 8888);
        DataStreamSource<String> ds2 = env.socketTextStream("node05", 9999);
